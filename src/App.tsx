    ...
    <MuiThemeProvider theme={theme}>
      <div className={Style.app__root}>
        <Grid container>
          ...
          <Grid item xs={4}>
            <div className={Style.app__logout}>
              <button className={Style.app__iconLogout} onClick={Logout}>
              ...
              />
              <button className={Style.app__btn} onClick={handlerEditPictures}>
                <Avatar 
